...
def all_books(request):
    if request.method == "GET":
        ...
        return render(
            request, template_name="books/all_books.html", context={"books": books}
        )
...
def for_adults_view(request):
    if request.method == "GET":
        ...
        return render(
            request,
            template_name="books/for_adults_view.html",
            context={"adults_book": adults_book},
        )
...
def for_teens_view(request):
    if request.method == "GET":
        ...
        return render(
            request,
            template_name="books/for_teens_view.html",
            context={"teens_book": teens_book},
        )
